...
const postsFunction = {
    'lzacgsearch': function (json_data, i) {
        return $("<posts class=\"posts-item list ajax-item no_margin flex\"><div class=\"post-graphic\"><div class=\"item-thumbnail\"><a target=\"_blank\" href=" + json_data[i]['res_url'] + "><img data-thumb=\"default\" src=" + json_data[i]['res_img_url'] + " data-src=\"https://ycychan.com/wp-content/themes/action/../img/thumbnail.svg\" alt=" + json_data[i]['res_title'] + " class=\"fit-cover radius8 lazyloaded\"></a></div></div><div class=\"item-body flex xx flex1 jsb\"><h2 class=\"item-heading\"><a target=\"_blank\" href=" + json_data[i]['res_url'] + ">" + json_data[i]['res_title'] + "</a></h2><div class=\"item-excerpt muted-color text-ellipsis mb6\">-</div><div><div class=\"item-tags scroll-x no-scrollbar mb6\"><a class=\"but c-blue\" title=\"没有更多了\" href=\"javascript:;\"><i class=\"fa fa-folder-open-o\" aria-hidden=\"true\"></i>-</a></div><div class=\"item-meta muted-2-color flex jsb ac\"><item class=\"meta-author flex ac\"><a href=\"javascript:;\"><span class=\"avatar-mini\"><img alt=\"-\" src=\"\" data-src=\"//ycychan.com/wp-content/themes/action/../img/avatar-default.png\" class=\"avatar avatar-id-1 ls-is-cached lazyloaded\"></span></a><span class=\"hide-sm ml6\">-</span><span title=\"-\" class=\"icon-circle\">-</span></item><div class=\"meta-right\"><item class=\"meta-comm\"><a data-toggle=\"tooltip\" title=\"-\" href=" + json_data[i]['res_url'] + "><svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-comment\"></use></svg>-</a></item><item class=\"meta-view\"><svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-view\"></use></svg>-</item><item class=\"meta-like\"><svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-like\"></use></svg>-</item></div></div></div></div></posts>");
    },
    'dmhysearch': function (json_data, i) {
        return $("<posts class=\"posts-item list ajax-item no_margin flex\"><div class=\"post-graphic\"><div class=\"item-thumbnail\"><a target=\"_blank\" href=" + json_data[i]['res_url'] + "><img data-thumb=\"default\" src=" + 'javascript:;' + " data-src=\"https://ycychan.com/wp-content/themes/action/../img/thumbnail.svg\" alt=" + json_data[i]['title'] + " class=\"fit-cover radius8 lazyloaded\"></a></div></div><div class=\"item-body flex xx flex1 jsb\"><h2 class=\"item-heading\"><a target=\"_blank\" href=" + json_data[i]['res_url'] + ">" + json_data[i]['title'] + "</a></h2><div class=\"item-excerpt muted-color text-ellipsis mb6\">-</div><div><div class=\"item-tags scroll-x no-scrollbar mb6\"><a class=\"but c-blue\" title=\"无分类\" href=" + json_data[i]['res_publisher_url'] + "><i class=\"fa fa-folder-open-o\" aria-hidden=\"true\"></i>" + json_data[i]['res_publisher'] + "</a></div><div class=\"item-meta muted-2-color flex jsb ac\"><item class=\"meta-author flex ac\"><a href=" + json_data[i]['res_group_url'] + "><span class=\"avatar-mini\"><img alt=\"-\" src=\"\" data-src=\"//ycychan.com/wp-content/themes/action/../img/avatar-default.png\" class=\"avatar avatar-id-1 ls-is-cached lazyloaded\"></span></a><span class=\"hide-sm ml6\">" + json_data[i]['res_group'] + "</   span><span title=" + json_data[i]['send_time'] + " class=\"icon-circle\">" + json_data[i]['res_type'] + "</span></item><div class=\"meta-right\"><item class=\"meta-comm\"><a data-toggle=\"tooltip\" title=\"-\" href=" + json_data[i]['res_url'] + "><svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-comment\"></use></svg>-</a></item><item class=\"meta-view\"><svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-view\"></use></svg>6</item><item class=\"meta-like\"><svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-like\"></use></svg>-</item></div></div></div></div></posts>");
    }
}
